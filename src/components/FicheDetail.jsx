...
// Le détail d'une fiche, tel qu'il s'affiche dans un panneau glissant.
//
// Il vivait replié sous la ligne de la liste, dans le même composant qu'elle.
// Trois conséquences : la grille et la vue compacte ne savaient pas l'afficher
// et basculaient la liste entière pour aller le chercher, détruisant la vue
// qu'on avait choisie ; les 288 lignes montaient chacune la machinerie des cinq
// panneaux d'édition pour afficher une jaquette ; et le geste « ouvrir une
// fiche » n'avait pas le même effet selon l'endroit d'où on le faisait.
//
// Séparé, il est monté une fois, à la demande, quelle que soit la vue.
    ...
    <div>
      ...
      <div style={{ display: "flex", gap: 14, marginBottom: g.style ? 12 : 16 }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          {/* Le titre est porté par l'en-tête du panneau, qui reste visible
              pendant qu'on défile. Le répéter ici prenait deux lignes au-dessus
              de l'écran le plus étroit, pour redire ce qu'on venait de lire. */}
