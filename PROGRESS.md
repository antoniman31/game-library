...
- **Filtres** combinables : plateforme, prêt, format, mode de jeu (solo / à plusieurs /
  coopératif, d'après Wikidata) et genre (dérivé de la bibliothèque, huit visibles puis
  le reste sur demande). **Tri** : A-Z, date, Metacritic.
